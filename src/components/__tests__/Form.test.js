...
describe("Form", () => {
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    // 2. Render the Form with interviewers, name, interviewer, and the onSave mock function
    ...
    // Check if validation messages are not present and onSave is called correctly
